...
class CHANNELS:
    ...
    def Channel_values_generation(self, Eleveation, Azimuth):
        ...
        PHI = RIS_element_gap*m.sin(m.radians(Azimuth))*m.cos(m.radians(Eleveation))/Wavelength
        ...
        matrix1_kronecler_matrix2 = tf.linalg.LinearOperatorKronecker([tf.linalg.LinearOperatorFullMatrix(Matrix_1), tf.linalg.LinearOperatorFullMatrix(Matrix_2)])
