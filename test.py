...
class Test:
    ...
    def Test(self,H_tr_to_RIS, H_RIS_to_rx, Testing_input, Autoencoder, model):
        ...
        for n in range(0,len(EbNodB_range)):
            ...
            Channel_1 = model.Tensor_multiplication_channel_tr_to_RIS([H_tr_to_RIS, encoded_signal])              
            ...
            channel_h_rx = model.Tensor_multiplication_channel_h_rx([H_RIS_to_rx, Y_RIS])                   
